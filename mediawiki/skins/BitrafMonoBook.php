 ...
 * @ingroup Skins
 */
class SkinBitrafMonoBook extends SkinTemplate {
	/** Using monobook. */
	function initPage( OutputPage $out ) {
		parent::initPage( $out );
		$this->skinname  = 'monobook';
		$this->stylename = 'monobook';
		$this->template  = 'BitrafMonoBookTemplate';
 ...
 * @ingroup Skins
 */
class BitrafMonoBookTemplate extends QuickTemplate {
	var $skin;
	/**
	 * Template filter callback for BitrafMonoBook skin.
...
<?php		}
		...
		wfRunHooks( 'BitrafMonoBookTemplateToolboxEnd', array( &$this ) );
